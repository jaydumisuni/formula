...
impl SelfExpansionNegativeControl {
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::RouteMissingPreservationEvidence => {
                "NC10-06_ROUTE_MISSING_PRESERVATION_EVIDENCE"
            }
...
impl SelfExpansionProofManifest {
    ...
    pub fn predecessor_p9(&self) -> ArtifactDigest { self.predecessor_p9 }
    pub fn source_generation(&self) -> ArtifactDigest { self.source_generation }
    pub fn expanded_generation(&self) -> ArtifactDigest { self.expanded_generation }
    pub fn world(&self) -> ArtifactDigest { self.world }
    pub fn registry_digest(&self) -> ArtifactDigest { self.registry_digest }
    pub fn rational_package_before(&self) -> ArtifactDigest { self.rational_package_before }
    pub fn rational_package_after(&self) -> ArtifactDigest { self.rational_package_after }
    pub fn closure_before(&self) -> ArtifactDigest { self.closure_before }
    pub fn closure_after(&self) -> ArtifactDigest { self.closure_after }
    pub fn closure_delta(&self) -> ArtifactDigest { self.closure_delta }
    pub fn unlocked_capability(&self) -> ArtifactDigest { self.unlocked_capability }
    pub fn structure_witness(&self) -> ArtifactDigest { self.structure_witness }
    pub fn base_promotion(&self) -> ArtifactDigest { self.base_promotion }
    pub fn expansion_authorization(&self) -> ArtifactDigest { self.expansion_authorization }
    pub fn lambda_before(&self) -> ArtifactDigest { self.lambda_before }
    pub fn lambda_after(&self) -> ArtifactDigest { self.lambda_after }
    pub fn nogood_proof(&self) -> ArtifactDigest { self.nogood_proof }
    pub fn route_proof(&self) -> ArtifactDigest { self.route_proof }
    pub fn shadow_metaprimitive(&self) -> ArtifactDigest { self.shadow_metaprimitive }
    pub fn semantic_change(&self) -> ArtifactDigest { self.semantic_change }
    pub fn proof_evolution(&self) -> ArtifactDigest { self.proof_evolution }
    pub fn realization_upgrade(&self) -> ArtifactDigest { self.realization_upgrade }
    pub fn realization_rollback(&self) -> ArtifactDigest { self.realization_rollback }
    pub fn negative_controls(&self) -> &SelfExpansionNegativeControlManifest { &self.negative_controls }
...
impl StructuralIdentity for SelfExpansionProofManifest {
    fn canonical_value(&self) -> CanonicalValue {
        ...
        value.insert("source_commit".into(), CanonicalValue::String(self.source_commit.clone()));
        value.insert("predecessor_p9".into(), CanonicalValue::Digest(self.predecessor_p9));
        value.insert("source_generation".into(), CanonicalValue::Digest(self.source_generation));
        value.insert("expanded_generation".into(), CanonicalValue::Digest(self.expanded_generation));
        value.insert("world".into(), CanonicalValue::Digest(self.world));
        value.insert("registry_digest".into(), CanonicalValue::Digest(self.registry_digest));
        value.insert("rational_package_before".into(), CanonicalValue::Digest(self.rational_package_before));
        value.insert("rational_package_after".into(), CanonicalValue::Digest(self.rational_package_after));
        value.insert("closure_before".into(), CanonicalValue::Digest(self.closure_before));
        value.insert("closure_after".into(), CanonicalValue::Digest(self.closure_after));
        value.insert("closure_delta".into(), CanonicalValue::Digest(self.closure_delta));
        value.insert("unlocked_capability".into(), CanonicalValue::Digest(self.unlocked_capability));
        value.insert("structure_witness".into(), CanonicalValue::Digest(self.structure_witness));
        value.insert("base_promotion".into(), CanonicalValue::Digest(self.base_promotion));
        value.insert("expansion_authorization".into(), CanonicalValue::Digest(self.expansion_authorization));
        value.insert("lambda_before".into(), CanonicalValue::Digest(self.lambda_before));
        value.insert("lambda_after".into(), CanonicalValue::Digest(self.lambda_after));
        value.insert("nogood_proof".into(), CanonicalValue::Digest(self.nogood_proof));
        value.insert("route_proof".into(), CanonicalValue::Digest(self.route_proof));
        value.insert("shadow_metaprimitive".into(), CanonicalValue::Digest(self.shadow_metaprimitive));
        value.insert("semantic_change".into(), CanonicalValue::Digest(self.semantic_change));
        value.insert("proof_evolution".into(), CanonicalValue::Digest(self.proof_evolution));
        value.insert("realization_upgrade".into(), CanonicalValue::Digest(self.realization_upgrade));
        value.insert("realization_rollback".into(), CanonicalValue::Digest(self.realization_rollback));
        value.insert("negative_controls".into(), self.negative_controls.canonical_value());
        value.insert("checker_identity".into(), CanonicalValue::Digest(self.checker_identity));
        value.insert("verifier_identity".into(), CanonicalValue::Digest(self.verifier_identity));
        CanonicalValue::Object(value)
    }
}
